                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-6 mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div id="myfileupload">
                                                            <input type="file" id="hotel_img" name="hotel_img" accept="image/*"  onchange="preview(event)">       
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6 mb-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div id="myfileupload">
                                                                <input type="file" id="hotel_img${hotel.hotel_id}" name="hotel_img" accept="image/*" onchange="previewImage(event, 'imagePreview${hotel.hotel_id}')">
                                                                <img id="imagePreview${hotel.hotel_id}" src="#" alt="Image Preview" style="display: none; width: 200px; margin-top: 10px;">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
