                    ...
                    <div class="card p-3">
                        ...
                        Account ac = aDAO.getAccount(value);
                            ...
                            <ul class="nav">                                
                                ...
                                <li class="nav-item"><a class="nav-link px-2" href="roommanager"><i class="fa fa-fw fa-database mr-1"></i><span>Room</span></a></li>
                                ...
                                <li class="nav-item"><a class="nav-link px-2" href="logout"><i class="fa fa-fw fa-arrow-left mr-1"></i><span>Logout</span></a></li>                                
                            </ul>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="align-middle text-center" style="width: 100px">
                                                                <div class="bg-light d-inline-flex justify-content-center align-items-center align-top" style="width: 70px; height: 35px; border-radius: 3px;"><img src="img/room/room-details.jpg" alt="" width="75px;"></div>
                                                            </td>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <ul class="pagination mt-3 mb-0">
                                                <c:forEach begin="${1}" end="${num}" var="i">                                                    
                                                    <li class="${i==page?"active page-item":"page-item"}"><a href="roommanager?page=${i}" class="page-link">${i}</a></li>                                                    
                                                    </c:forEach>
                                            </ul>
                                        </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="py-1">
                                    <form class="form" novalidate="" action="roommanager?action=insertroom" method="POST">
                                        <div class="row">
                                            <div class="col">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <label>No.Room</label>
                                                            <input class="form-control" type="text" name="name" placeholder="Room number" value="">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group">
                    ...
                    <div class="modal fade" role="dialog" tabindex="-1" id="update-form-modal${room.room_id}" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="py-1">
                                        <form class="form" novalidate="" action="roommanager?action=updateroom" method="POST">
                                            <div class="row">
                                                <div class="col mb-3">
                                                    <div class="form-group">
                                                        <label>Room ID</label>
                                                ...
                                                <div class="col">
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                <label>No.Room</label>
                                                                <input class="form-control" type="text" name="name" placeholder="Room number" value="${room.room_name}">
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="form-group">
        ...
        <script>
                                                                        function doDelete(id) {
                                                                            if (confirm("Are you sure to delete room with ID = " + id)) {
                                                                                window.location = "roommanager?action=deleteroom&id=" + id;
                                                                            }
                                                                        }
        </script>
    </body>
