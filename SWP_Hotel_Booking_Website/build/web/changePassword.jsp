<%-- 
    ...
    Created on : Jun 23, 2024, 4:41:23 PM
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-3 sidebar">
                    <button class="btn btn-custom" onclick="location.href = 'profile?action=updateprofile'">
                    ...
                    <button class="btn btn-secondary" onclick="location.href = 'profile?action=changepassword'">
                ...
                <div class="container col-md-9">
                    <div class="card profile-card">
                        ...
                        <div class="card-body">
                            <form action="profile?action=changepassword" method="post" id="changePasswordForm">
