...
WHERE h.hotel_address LIKE '%nha trang%' 
  AND (('2024-07-18' BETWEEN rs.check_in_date AND rs.check_out_date 
        OR '2024-08-05' BETWEEN rs.check_in_date AND rs.check_out_date) 
       OR (rs.check_in_date BETWEEN '2024-07-18' AND '2024-08-05' 
           OR rs.check_out_date BETWEEN '2024-07-18' AND '2024-08-05')) 
