...
WHERE h.hotel_id = 1  
  AND (('2024-07-18' BETWEEN rs.check_in_date AND rs.check_out_date 
        OR '2024-07-19' BETWEEN rs.check_in_date AND rs.check_out_date) 
       OR (rs.check_in_date BETWEEN '2024-07-18' AND '2024-07-19' 
           OR rs.check_out_date BETWEEN '2024-07-18' AND '2024-07-19')) 
...
select * from Reservation where username = 'dat' ORDER BY [status] ASC;
